  ...
  const mockProducts = [
    {
      ...
      specifications: {
        ...
        camera:
          "48MP main, 12MP ultra wide, 12MP telephoto with 5x optical zoom",
    ...
    },
    {
      ...
      specifications: {
        ...
        ports:
          "3 Thunderbolt 4 ports, HDMI port, SDXC card slot, MagSafe 3 port",
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-6">
        ...
        <p className="fs-3 text-primary fw-bold mb-4">
